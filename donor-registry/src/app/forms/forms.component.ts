...
export class FormsComponent implements OnInit {
  ...
  ngAfterViewChecked() {
    if (this.form == 'signup') {
      if (localStorage.getItem('isVerified')) {
        if (
          this.model['identificationDetails'] &&
          this.model['identificationDetails'].hasOwnProperty('abha')
        ) {
          this.tempData = JSON.parse(
            localStorage.getItem(
              this.model['identificationDetails']['abha'].replaceAll('-', '')
            )
          );
            ...
            this.model = {
              ...
              personalDetails: {
                ...
                gender: this.tempData?.gender
                  ? `${GenderMap[this.tempData?.gender]}`
                  : {},
                emailId: this.tempData?.email ? this.tempData?.email : '',
                mobileNumber: this.tempData?.mobile,
                dob:
                  this.tempData?.yearOfBirth +
                  '-' +
                  ('0' + this.tempData?.monthOfBirth).slice(-2) +
                  '-' +
                  ('0' + this.tempData?.dayOfBirth).slice(-2),
              },
              addressDetails: {
                ...('addressDetails' in this.model
                  ? this.model['addressDetails']
                  : {}),
              ...
              emergencyDetails: this.model['emergencyDetails']
                ? this.model['emergencyDetails']
                : {},
              pledgeDetails: this.model['pledgeDetails']
                ? this.model['pledgeDetails']
                : {},
              // "notificationDetails": this.model["notificationDetails"]? this.model["notificationDetails"] : {},
              instituteReference: this.model['instituteReference']
                ? this.model['instituteReference']
                : '',
            };
            valuesSetFlag = true;
          }
  ...
  ngAfterContentChecked(): void {
    if (this.model['memberToBeNotified'] == true) {
      this.model = {
        ...
        identificationDetails: this.model['identificationDetails']
          ? this.model['identificationDetails']
          : {},
        personalDetails: this.model['personalDetails']
          ? this.model['personalDetails']
          : {},
        addressDetails: this.model['addressDetails']
          ? this.model['addressDetails']
          : {},
        pledgeDetails: this.model['pledgeDetails']
          ? this.model['pledgeDetails']
    ...
    if (this.model['memberToBeNotified'] == false) {
      if (JSON.stringify(this.model['notificationDetails']) != '{}') {
        if (
          JSON.stringify(this.model['notificationDetails']) ===
          JSON.stringify(this.model['emergencyDetails'])
        ) {
          this.model = {
            notificationDetails: {
              name: '',
    ...
    if (
      ...
      if (
        this.model['donorDetails'] &&
        this.model['donorDetails'].hasOwnProperty('identificationValue')
      ) {
        let tempData;
        if (this.identifier) {
          tempData = this.model;
          ...
          tempData = JSON.parse(
            localStorage.getItem(
              this.model['donorDetails']['identificationValue']
            )
          );
        }

        if (
          tempData.hasOwnProperty('monthOfBirth') &&
          tempData['monthOfBirth'] < 10
        ) {
          tempData['monthOfBirth'] = '0' + tempData['monthOfBirth'];
        }

        if (
          tempData.hasOwnProperty('dayOfBirth') &&
          tempData['dayOfBirth'] < 10
        ) {
     ...
     */
        this.model = {
          ...
          recipientDetails: this.model['recipientDetails']
            ? this.model['recipientDetails']
            : {},
          crossMatchDetails: this.model['crossMatchDetails']
            ? this.model['crossMatchDetails']
            : {},
          dnaProfiling: this.model['dnaProfiling']
            ? this.model['dnaProfiling']
            : {},
          donorHLA: this.model['donorHLA'] ? this.model['donorHLA'] : {},
          medicalDetails: this.model['medicalDetails']
            ? this.model['medicalDetails']
            : {},
          medicalHistory: this.model['medicalHistory']
            ? this.model['medicalHistory']
            : {},
          proofOfRelation: this.model['proofOfRelation']
            ? this.model['proofOfRelation']
            : {},
          recipientHLA: this.model['recipientHLA']
            ? this.model['recipientHLA']
            : {},
          swapDetails: this.model['swapDetails']
            ? this.model['swapDetails']
            : {},
          relationOfDonorRecipient: this.model['relationOfDonorRecipient']
            ? this.model['relationOfDonorRecipient']
            : '',
          crossMatching: this.model['crossMatching']
            ? this.model['crossMatching']
            : '',
          proofOfRelationtype: this.model['proofOfRelationtype']
            ? this.model['proofOfRelationtype']
            : '',
      ...
      if (
        this.model['recipientDetails'] &&
        (this.model['recipientDetails'].hasOwnProperty('identificationValue') ||
          this.model['recipientDetails']['recipientId'])
      ) {
        let tempData;
        if (this.identifier) {
          tempData = JSON.parse(
            localStorage.getItem(this.model['recipientDetails']['recipientId'])
          );
        } else {
          tempData = JSON.parse(
            localStorage.getItem(
              this.model['recipientDetails']['identificationValue']
            )
          );
        }
        ...
        this.model = {
          donorDetails: this.model['donorDetails']
            ? this.model['donorDetails']
            : {},
          recipientDetails: {
            identificationValue: this.model['recipientDetails'][
              'identificationValue'
            ]
              ? this.model['recipientDetails']['identificationValue']
              : this.model['recipientDetails']['recipientId'],
      ...
      if (
        ...
        this.model = {
          recipientDetails: {
            ...
            middleName: tempData['middleName'],
            mobileNumber: tempData['mobile'],
            residentialProof: this.model['recipientDetails']['residentialProof']
              ? this.model['recipientDetails']['residentialProof']
              : '',
            residentialValue: this.model['recipientDetails']['residentialValue']
              ? this.model['recipientDetails']['residentialValue']
              : '',
            passportNumber: this.model['recipientDetails']['passportNumber']
              ? this.model['recipientDetails']['passportNumber']
              : '',
            country: this.model['recipientDetails']['country']
              ? this.model['recipientDetails']['country']
              : 'SriLanka',
            mobileNumberWithCode: this.model['recipientDetails'][
              'mobileNumberWithCode'
            ]
              ? this.model['recipientDetails']['mobileNumberWithCode']
              : '',
            form21: this.model['recipientDetails']['form21']
              ? this.model['recipientDetails']['form21']
              : '',
            nationality: this.model['recipientDetails']['nationality']
              ? this.model['recipientDetails']['nationality']
              : 'Indian',
          },
          medicalDetails: this.model['medicalDetails']
            ? this.model['medicalDetails']
          ...
          medicalHistory: this.model['medicalHistory']
            ? this.model['medicalHistory']
            : {},
          bloodGroupDetails: this.model['bloodGroupDetails']
            ? this.model['bloodGroupDetails']
            : {},
          hematology: this.model['hematology'] ? this.model['hematology'] : {},
          LiverExamination: this.model['LiverExamination']
            ? this.model['LiverExamination']
            : {},
          urineExam: this.model['urineExam'] ? this.model['urineExam'] : {},
          biochemistry: this.model['biochemistry']
            ? this.model['biochemistry']
            : {},
          ekg: this.model['ekg'] ? this.model['ekg'] : {},
          thyroidFunction: this.model['thyroidFunction']
            ? this.model['thyroidFunction']
            : {},
          ...
          recipientHLA: this.model['recipientHLA']
            ? this.model['recipientHLA']
            : '',
          organsOrTissues: this.model['organsOrTissues']
            ? this.model['organsOrTissues']
            : { organsNeeded: ['Kideny'] },
  ...
  ngOnInit(): void {
    let temp = {
      ...
      middleName: 'Nitin',
      lastName: 'Rairikar',
      name: 'Chaitrali Nitin Rairikar',
      yearOfBirth: '1998',
      dayOfBirth: '30',
      monthOfBirth: '3',
      gender: 'F',
      email: 'chaitralir30@gmail.com',
    };

    localStorage.setItem('91545785186764', JSON.stringify(temp));
    let temp1 = {
      healthIdNumber: '91-5457-8518-6763',
      healthId: null,
      mobile: '7709151274',
      firstName: 'Pratiksha',
    ...
    this.schemaService.getFormJSON().subscribe(
      (FormSchemas) => {
        ...
        if (this.formSchema.description) {
          this.formDescription = this.translate.instant(
            this.formSchema.description
          );
        }
        if (this.formSchema.subDescription) {
          this.subDescription = this.translate.instant(
            this.formSchema.subDescription
          );
        }
      ...
      fieldset.fields.forEach((field) => {
        ...
        if (field.custom && field.element) {
          ...
          if (field.element.hasOwnProperty('key')) {
            this.responseData.definitions[fieldset.definition].properties[
              field.name
            ]['key'] = this.translate.instant(field.element.key);
          }
  ...
  addWidget(fieldset, field, childrenName) {
    ...
    if (field.widget) {
      ...
      if (field.hasOwnProperty('hideExpression') && field.hideExpression) {
        this.responseData.definitions[fieldset.definition].properties[
          field.name
        ]['widget']['formlyConfig']['hideExpression'] = true;
      }
      ...
      if (field.hasOwnProperty('condition') && field.condition) {
        if (field.condition.type == 'hideShow') {
          let temp =
            this.responseData.definitions[fieldset.definition].properties[
              field.name
            ]['widget']['formlyConfig']['fieldGroupClassName'];

          this.responseData.definitions[fieldset.definition].properties[
            field.name
          ]['widget']['formlyConfig'] = {
            hideExpression: (model, formState, field1) => {
              return !this.model['organsOrTissues']['organsNeeded'].includes(
                field.condition.isInclude
              );
            },
          };
          ...
          this.responseData.definitions[fieldset.definition].properties[
            field.name
          ]['widget']['formlyConfig']['fieldGroupClassName'] = temp;
      ...
      if (field.type) {
        if (field.type === 'verify-code') {
          ...
          this.responseData.definitions[fieldset.definition].properties[
            ...
            this.translate.instant('XX-XXXX-XXXX-XXXX');
          if (field.required) {
            this.responseData.definitions[fieldset.definition].properties[
              field.name
            ]['widget']['formlyConfig']['templateOptions']['placeholder'] =
        ...
        if (field.type === 'multicheckbox') {
          if (
            ...
            delete this.responseData.definitions[fieldset.definition]
              .properties[field.name]['items'];
          }

          this.responseData.definitions[fieldset.definition].properties[
            field.name
          ]['widget']['formlyConfig']['templateOptions']['type'] = 'array';
          this.responseData.definitions[fieldset.definition].properties[
            field.name
          ]['widget']['formlyConfig']['type'] = field.type;
          if (this.form == 'recipient') {
  ...
  async postData() {
    ...
    if (this.form == 'signup') {
      await this.http
        .post<any>(`${getDonorServiceHost()}/esign/init`, { data: this.model })
        .subscribe(async (res) => {
          ...
          const eSignWindow = window.open(
            '',
            'pledge esign',
            'location=no, height=800, width=1000, left=' + x + ',top=' + y
          );
...
\t</script>`);
          ...
          while (checkESignStatus) {
            try {
              this.http
                .get<any>(
                  `${getDonorServiceHost()}/esign/${
                    this?.model['identificationDetails']['abha']
                  }/status`
                )
                .subscribe(
                  (res) => {
          ...
          eSignWindow.close();
          await this.http
            .post<any>(`${getDonorServiceHost()}/register/Pledge`, this.model)
            .subscribe(
              (res) => {
                if (
  ...
  async callPostAPI(url = this.apiUrl) {
    await this.generalService.postData(url, this.model).subscribe(
      (res) => {
