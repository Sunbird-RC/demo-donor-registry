...
export class VerifyIndentityCode extends FieldType {
  ...
  openModal(){
    ...
    let person = prompt("Enter the code sent to mobile number associated with your ID", "");
