...
@Component({
  ...
  template: `
      <div>
       ...
       <div class="p12">Generate ABHA number through this link <a href="https://healthid.ndhm.gov.in/register" target="_blank">https://healthid.ndhm.gov.in/register</a></div> <br>
